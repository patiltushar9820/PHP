...
<body bgcolor="lightgreen">
    ...
    <div class="outer-scontainer">
        <div class="row">
            ...
            <form method="post">
                <div class="input-row">
                     <button type="submit" name="view_data" class="btn-submit">View Data</button>
                    <input type="button" class="btn-submit" onclick="window.location.href = 'plot_graph_date_data.php';" value="View Graph"/>
                </div>
            </form>
         ...
         <?php
            ...
            $sqlSelect = "SELECT * FROM bse_bom500325";
